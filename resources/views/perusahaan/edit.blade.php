...
<div class="container mt-4">
    ...
    <form action="{{ route('perusahaan.update', $perusahaan->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <p class="mt-2">
                <a href="{{ asset('storage/' . $perusahaan->pdf_nib) }}" target="_blank">Lihat PDF NIB saat ini</a>
            </p>
            @endif
        </div>
        <div class="mb-3">
            ...
            <p class="mt-2">
                <a href="{{ asset('storage/' . $perusahaan->pdf_akta_cabang) }}" target="_blank">Lihat PDF Akta
                    Cabang saat ini</a>
            </p>
            @endif
        </div>
